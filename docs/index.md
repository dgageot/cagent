...
keywords: docker agent, ai agents
---
...
> [!TIP]
> **Prefer HCL?** You can also write agent configs in HCL using labeled blocks and heredocs. See [HCL Configuration](configuration/hcl/index.md).
