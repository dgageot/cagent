...
keywords: docker agent, ai agents, model providers, docker model runner
---
...
> [!TIP]
> **No API key needed**: DMR runs models locally — your data never leaves your machine. Great for development, sensitive data, or offline use.
