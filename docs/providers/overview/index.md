...
keywords: docker agent, ai agents, model providers
---
...
> [!TIP]
> **Multi-provider teams**: Use expensive models for complex reasoning and cheaper/local models for routine tasks. See the example below.
